    ...
    render() {
        return (
            <section className="grid">
                ...
                <pre>
                    <code className="sh">
                        npm install https://github.com/nowarkdev/grid --save
                    </code>
                </pre>
                ...
                <pre>
                    <code className="scss">
                        @import "../node_modules/nowtv-grid/dist/scss/nowtv_grid.scss";
                    </code>
                </pre>
                ...
                <pre>
                    <code className="sh">
                        "../node_modules/nowtv-grid/dist/css/nowtv_grid.css"
                    </code>
                </pre>
